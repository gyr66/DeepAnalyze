...
path = "/home/mnt/guoyiran/download/dsbench/data_modeling/save_performance/"
baseline_path = f"{path}baseline"
save_path = f"{path}{model}"
gt_path = f"{path}GT"

output_path = f"/home/mnt/guoyiran/download/dsbench/data_modeling/output_model/{model}"
